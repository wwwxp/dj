		...
		if (object.changeType == "single") {
			for (var d = 0; d < object.objectData.length; d++) {
				...
				if (object.cloums == undefined) {
					fcfxml = fcfxml + "<set label='" + o[object.categoryName] + "' toolText='" + o[object.toolText] + "' value='" + o[object.seriesname] + "' color='" + ajustColor(d) + "'" + setAtributes + setLink(o[object.categoryName], ajustColor(d)) + " />";
				} else {
			...
			/*mini.alert(mini.encode(fcfxml));
			
			for (var d = 0; d < object.objectData.length; d++) {
				var o = object.objectData[d];
				if (object.cloums == undefined) {
					//mini.alert(o[object.categoryName]);
					fcfxml = fcfxml + "<dataset seriesname='" + o[object.categoryName] + "'" + " showLegend='1' legendPosition='RIGHT' " + ">";
					fcfxml = fcfxml + "<set value='" + o[object.categoryName] + "'" + setAtributes + " />";
