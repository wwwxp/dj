 ...
 */
function load(param){
    //datagridLoad(JsVar["overstockGrid"], param, null, Globals.baseActionUrl.TASK_OVERSTOCK_SERVICE_DATA_QUERY_WITH_GROUP_URL);
...
function loadWorkerData() {
	var gridData = JsVar["overstockGrid"].getData();
	var mergeCells2="TOPOLOGY_NAME";
 	var mergeCellColumnIndex2="0";
	var mergeData = getMergeCellsOnGroup(gridData, mergeCells2, mergeCellColumnIndex2);
	JsVar["overstockGrid"].mergeCells(mergeData);
}
