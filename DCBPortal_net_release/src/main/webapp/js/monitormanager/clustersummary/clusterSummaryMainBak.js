...
//循环执行，每隔1秒钟执行一次 1000
     var t1=window.setInterval(getData, 5000);
    //去掉定时器的方法
...
function getTestData(){
    tCount ++;
    if(tCount<=5){
        return r2Data[r2Data.length-1]+5000;

    }else{
        return r2Data[r2Data.length-1];
    }
}
...
function getData() {
    ...
    getJsonDataByPost(url, null,null, function (result) {
        ...
        console.log(line2Data.name+"文件里总数:"+result.DATA[line2Data.name] + "，上次文件总数:"+r2Data[r2Data.length-2] +",增加数量：" + (parseInt(r2Data[r2Data.length-1]) -parseInt(r2Data[r2Data.length-2])));
        ...
        //console.log(line2Data.name+"文件里总数:"+r2Data[r2Data.length-1] + "，上次文件总数:"+r2Data[r2Data.length-2] +",增加数量：" + (parseInt(r2Data[r2Data.length-1]) -parseInt(r2Data[r2Data.length-2])));
        var provNum1=0;
        var provNum2=0;
        var provNum3=0;
        var provNum4=0;

        var abCount1 = parseInt(r1Data[r1Data.length-1]) -parseInt(r1Data[r1Data.length-2]);
        if(abCount1 > 1){
        ...
        var bbbb= 0;
        var abCount2 = parseInt(r2Data[r2Data.length-1]) -parseInt(r2Data[r2Data.length-2]);
        if(abCount2 >1){
        ...
        var abCount3 = parseInt(r3Data[r3Data.length-1]) -parseInt(r3Data[r3Data.length-2]);
        if(abCount3 > 1){
        ...
        var abCount4 = parseInt(r4Data[r4Data.length-1]) -parseInt(r4Data[r4Data.length-2]);
        if(abCount4 >1){
        ...
        console.log("累加次数:" + bbbb+ ",和除以数:" + (index2-1) +"相等,累加的TPS:"+ provNum2 +",除后TPS："+Math.ceil(provNum2/(index2-1)));
