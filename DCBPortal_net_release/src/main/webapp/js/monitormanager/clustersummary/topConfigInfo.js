...
function getForwardParams(){
	...
	DataObj["topologyId"] = getQueryString('topologyId');
}
...
function loadDataGrid(){
	datagridLoad(JsVar["configGrid"],DataObj,"",Globals.baseActionUrl.MONITOR_ACTION_SUMMARY_TOPOLOGY_CONFIGURATION_URL);
}
