...
function postAjaxForDeploy(host_arry){
	...
	getJsonDataByPost(Globals.baseActionUrl.FASTDFS_TASK_ACTION_STOP_DEPLOY_INFOMATION_URL,host_arry,"启停管理--停止Fastdfs",
		function(result){
			if(result && result["RST_STR"] != ""){
				...
				if (result["RST_CODE"] == busVar.FAILED) {
