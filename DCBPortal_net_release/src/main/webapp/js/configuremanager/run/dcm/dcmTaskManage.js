...
function onActionRenderer(e) {
    ...
    var html = '<a class="Delete_Button" href="javascript:run(' + index + ')">查看</a>';
    return html;
}
...
function runStateRenderer(e){
	...
	if(run_pro==null || run_pro<1){
		...
		return "<span class='label label-danger'>&nbsp;无运行程序实例&nbsp;</span>";
	}else{
		JsVar["run_pro"] = run_pro;
...
function run(index){
	...
	showDialog("程序管理", "98%", "98%", Globals.baseJspUrl.DCM_PROGRAM_JSP_MANAGE_URL,
