...
function onClickTreeNode(e){
	...
	//是文件,获取文件内容
	if(isFile==true){
		getJsonDataByPost(Globals.baseActionUrl.CONFIGURE_ACTION_FILE_BUS_CONTENT_URL,params,"配置修改-FTP/SFTP获取文件内容",
			function(result){
				if(result!=null){
...
function saveFile(e){
	...
	var params = {
        parentDiv:Tree["fileTree"].getParentNode(node).fileName,
	...
	//保存和分发
	getJsonDataByPost(Globals.baseActionUrl.CONFIGURE_ACTION_FILE_SAVE_BUS_URL,params,"配置修改-业务配置-分发修改后的文件",
		function(result){
