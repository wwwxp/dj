...
<script type="text/javascript" src="${ctx}/js/clustermanager/addHostPartition.js"></script>
</head>
<body>
	<div id="FitDiv" class="mini-fit p5" style="overflow: auto;">
		<div style="height:99%;overflow: auto;border: 1px solid #b1c3e0;">
			...
			<div id="clusterDiv" style="height: 30px;border-bottom: 1px dashed #b1c3e0;padding-top: 5px;padding-left: 5px;display: none;">
				<span id="clusterSpan">Jstorm集群：</span>
				<input class="mini-combobox" id="JSTORM_CLUSTER_ID" name="JSTORM_CLUSTER_ID" valueField="CLUSTER_ID" 
					textField="CLUSTER_NAME" onvaluechanged="loadJstormClusterList" style="width: 200px;"/>
			</div>
			<div id="hostNameDiv" style="height: 30px;border-bottom: 1px dashed #b1c3e0;padding-top: 5px;padding-left: 5px;">
				<span id="clusterSpan">请选择用户：</span>
				<input class="mini-combobox" id="SSH_USER" name="SSH_USER" valueField="SSH_USER" 
					textField="SSH_USER" onvaluechanged="sshUserChange" style="width: 200px;"/>
			</div>
	...
	<div class="mini-toolbar" style="height:28px;text-align: center; padding-top: 8px; padding-bottom:8px;"
	    borderStyle="border:0;border-top:solid 1px #b1c3e0;">
		   <a class="mini-button"onclick="chooseDeploy()">新增</a>
