...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script
		src="${ctx}/js/clustermanager/businessassigned/busCfgFileDispatchPrivilege.js"
...
<body>
	<div class="search">
		<table style="width: 100%; height: 100%;">
			<tr>
				<td><span style="margin-left: 5px;">节点名称： </span> <input
					id="PROGRAM_NAME" name="PROGRAM_NAME" class="mini-textbox"
					style="width: 180px; margin-left: 5px;" onenter="onKeyEnter" /> <a
	...
	<div class="mini-fit">
		<table style="height: 100%; width: 100%" id="tableDi">
