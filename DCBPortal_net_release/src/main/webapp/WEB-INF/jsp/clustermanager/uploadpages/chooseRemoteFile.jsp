...
<script language="javascript" type="text/javascript" src="${ctx}/js/clustermanager/chooseRemoteFile.js"></script>
</head>
<body>
	<div class="mini-fit p5" style="overflow: auto;">
		<div id="rbl" class="mini-radiobuttonlist" repeatItems="2" repeatLayout="table" repeatDirection="horizontal"
