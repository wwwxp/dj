...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/clustermanager/fileView.js"></script>
</head>
<body>
 	<div class="mini-fit p5">
		<table id="uploadForm" class="formTable6" style="table-layout: fixed;">
			...
			<tr>
				...
				<td >
					<input id="CRT_DATE" name="CRT_DATE" required="true" class="mini-datepicker" style="width:100%;" format="yyyy-MM-dd HH:mm:ss" enabled="false"/>
				</td>
			</tr>
			<tr>
			</tr>
			<tr>
				...
				<td colspan="3">
					<input id="DESCRIPTION" name="DESCRIPTION" required="false" class="mini-textarea" 
						style="width:100%; height:150px" enabled="false"/>
				</td>
			</tr>
		</table>
	</div>
