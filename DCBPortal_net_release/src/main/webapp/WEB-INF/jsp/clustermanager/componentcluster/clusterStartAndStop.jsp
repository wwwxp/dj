...
<script type="text/javascript" src="${ctx}/js/clustermanager/componentcluster/clusterStartAndStop.js"></script>

</head>
<body>
<div class="mini-fit" style="overflow:auto;min-width: 1200px;" id="fitDiv">
	<div id="fitDiv_cont">
