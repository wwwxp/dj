...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/monitor/resource/nimbusConfig.js"></script>
	...
	<div class="mini-fit" style="margin-top: 5px;">
		<div id="configGrid" class="mini-datagrid" style="width: 100%; height: 100% ; "
			...
			<div property="columns">
				...
				<div field="value" width="140" headerAlign="center" align="left">Value</div>
			</div>
		</div>
	</div>
    </div>
