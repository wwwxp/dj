...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/monitor/prepaid/prePaidMonitorHistory.js"></script>
...
<body>
		...
		<div id="queryFrom" class="search">
			<table class="formTable8" style="width:100%;height:50px;table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
				...
				<th>
					...
					format="yyyy-MM-dd H:mm:ss" showTime="true" timeFormat="H:mm:ss" style="width:95%;" />
					</td>
	            	<th>
	            		<span>结束时间：</span>
	            	</th>
					...
					timeFormat="H:mm:ss" showTime="true" style="width:95%;" />
					</td>
					<td>
	...
	<div class="mini-fit" style="margin-top: 5px;">
		<div id="historyGrid" class="mini-datagrid" style="width: 100%; height: 50%"
             idField="" allowResize="false" allowCellselect="false" multiSelect="false" allowCellWrap="true"  
              onrowclick="onclickHistoryGrid" showFooter="true" >
			<div property="columns">
			   <div type="checkcolumn" width="25">序号</div>
				...
				<div field="BEGIN_TIME" width="130" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss" >开始时间</div>
				<div field="END_TIME" width="130" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss" >结束时间</div>
			</div>
		</div>
