...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/monitor/pressure/addExtendNode.js"></script>
    ...
    <div class="mini-fit p5">
        <table id="nodeForm" class="formTable6" style="table-layout: fixed;">
             ...
             <tr>
                ...
                <td>
               <input width="100%"  id="id" name="id" class="mini-textbox"  required="true"/>
                </td>
               ...
               <input width="100%" id="location_y" name="location_y" class="mini-textbox" required="true" vtype="int"/>
                ...
                <tr>
                <th width="120">连接线源节点：</th>
                <td>
                <input width="100%" id="fromNode" name="fromNode" class="mini-combobox"  popupHeight="120" textField="text" valueField="_id"  />
                </td>
                <th width="120">连接线目标节点：</th>
                <td>
               <input width="100%" id="toNode" name="toNode" class="mini-combobox"  popupHeight="120" textField="text" valueField="_id" />
                </td>
                </tr>
                <tr>
                ...
                <input width="100%"  id="image_url" name="image_url" class="mini-treeselect"  
                    textField="name" valueField="path" parentField="parentPath"  ondrawnode="onDrawNode" 
                       expandOnLoad="true" popupHeight="120"  popupWidth="250" />
