...
<title>查看配置文件</title>
    ...
    <script language="javascript" type="text/javascript" src="${ctx}/js/configuremanager/deployinstconfig/showMutilBusConfigContent.js"></script>
	<!--   主题样式 start -->
     <!--默认  codemirror.css-->
...
<body>
<div class="mini-fit">
	<div id="queryFrom" class="search" style="border-top:none;">
		<table class="formTable8" style="width:100%;height:30px;table-layout: fixed; padding: 0;" cellpadding="0" cellspacing="0">
			...
			<tr><th id="configFile" style="width:120px;">配置文件：</th>
			<td><input width="100%" id="copyFilesNames" name="copyFilesNames"
					class="mini-combobox" required="true" multiSelect="false" showNullItem="false"
					textField="fileName" valueField="fileName" onvaluechanged="loadContent"/></td>
		</table>
	</div>
