...
<head>
	<title>DCCP云计费平台-版本回退</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <%@ include file="/public/common/common.jsp"%>
    <link rel="stylesheet" type="text/css" href="${ctx}/css/form/form.css" />
	<script language="javascript" type="text/javascript"
		src="${ctx}/js/configuremanager/masterstandbyNet/rollbackOpt.js"></script>
</head>
<body>
	<div class="mini-fit p5">
		<div class="mini-fit">
			<div style="width: 48%;height: 100%;float: left;">
				...
				<div class="mini-fit" style="margin-top: 5px;">
					<div class="mini-panel" title="待回退程序节点运行状态" style="width: 100%;height: 100%;">
						<div id="lastversionGrid" class="mini-datagrid" style="width: 100%; height: 100%"
				...
				<div class="mini-fit">
					<div id="arrowDiv" style="height:100%;width:100%;">
						<%-- <div style="height: 30%;width: 100%;">
							<img src="${ctx}/images/arrow_left.png" style="width:32px;height:32px;margin-top:25%;">
						</div> --%>
						<div style="height: 100%;width: 100%;">
							<img src="${ctx}/images/arrow_02.png" style="width:32px;height:32px;position:relative;top:50%;transform:translateY(-50%);">
						</div>
				...
				<div id="upgradForm" class="search">
					<table class="formTable8" style="width:100%;height:50px;table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td>
								<input id="ROLLBACK_LIST" name="ROLLBACK_LIST" class="mini-combobox" style="width: 70%;"
									onvaluechanged="changeRollbackTopology();"
									textField="PROGRAM_TEXT" valueField="ID" showNullItem="false" allowInput="false"/>
								<a class="mini-button mini-button-green" onclick="upgradHistory()" id="sumbitButton" style="margin-left:10px;width:120px;">升级历史记录</a>
							</td>
						</tr>
					</table>
				</div>
				<div class="mini-fit" style="margin-top: 5px;">
					<div class="mini-panel" title="已升级程序节点运行状态" style="width: 100%;height: 100%;">
						<div id="rollbackGrid" class="mini-datagrid" style="width: 100%; height: 100%"
				             idField="HOST_IP" allowResize="false" allowCellselect="false" multiSelect="true" showFooter="false" >
							<div property="columns">
								<!-- <div type="checkcolumn" width="20" headerAlign="center" align="center"></div> -->
								<div field="HOST_IP" width="120" headerAlign="center" align="center">主机IP</div>
		...
		<div class="mini-toolbar" style="height:45px;text-align: center;margin-top:5px;">
   			<a class="mini-button mini-button-green" onclick="rollbackVersion()" id="sumbitButton" style="margin-top:10px;">版本回退</a> 
