...
<script type="text/javascript" src="${ctx}/js/configuremanager/m2db_refresh_tables.js"></script>
</head>
<body>
		...
		<div id="inputForm">
			<table id="paramsTable" class="formTable6" style="width:100%;min-height:5px;table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<th>是否重启：</th>
					<td><div id="isRestartProcess" style="line-height: 25px;" name="isRestartProcess" class="mini-checkbox" readOnly="false" text="acWholeRefresh程序" ></div></td>
				 </tr>
				 <tr>
				    <th><input type="radio"  name="searchRadio" value="1"  checked="true"/>表名：</th>
				    <td><input  type="text" id="tables" class="mini-textbox" name="tables" style="width:95%"/></td>
				    <td colspan="2"><span style="color: red">当不填时，刷新所有表;</span></td>
				 </tr>
				 <tr>
				    <th><input type="radio" id="searchRadio" name="searchRadio" value="2" />操作表：</th>
				    <td colspan="3"><input  type="text" id="cmdParam" class="mini-textarea" name="cmdParam" style="width:85%;height:100px;"/>
				   <span style="color: red">命令模式，如多条语句用“;”隔开</span></td>
				 </tr>
			</table>
		</div>
	</div>
