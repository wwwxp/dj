...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/configuremanager/run/runsameip/runSameProgramManage.js"></script>
</head>   
<body> 
<div id="mainDiv" class="mini-fit p5" style="overflow-x:hidden;overflow-y: auto;">
			...
			<tr>
				...
				<td>
					<input id="CONFIG_FILE" name="CONFIG_FILE" valueField="targetPath" textField="fileNameExt" allowInput="true"
						...
						class="mini-treeselect" parentField="parentId" showFolderCheckBox="false" onvaluechanged="changeConfigFile" style="width:98%;"/>
				</td>
				<th></th>
				<td></td>
			</tr>
    ...
    <div id="programGrid" class="mini-datagrid" style="width: 100%;height:auto;margin-top:5px; "
		...
		<div property="columns">
			...
			<div name="LATN_NAME" field="LATN_NAME"  width="50" headerAlign="center" allowSort="true" align="center">本地网</div>
			<div name="HOST_IP" field="HOST_IP" width="60" headerAlign="center" allowSort="true" align="center">运行主机</div>
<!-- 			<div name="CONFIG_FILE_PATH" field="CONFIG_FILE_PATH" width="150" headerAlign="center" allowSort="true" align="center">配置文件</div>-->

			<%--<div name="SCRIPT_SH_NAME" field="SCRIPT_SH_NAME" width="150" headerAlign="center" allowSort="true" align="left">脚本</div>--%>

			<div name="SCRIPT_SH_NAME" field="SCRIPT_SH_NAME" width="150" headerAlign="center" allowSort="true" align="left">脚本
				<input property="editor" class="mini-textbox" style="width:100%;" minWidth="100"/>
			</div>
			<div name="PROGRAM_DESC"  field="PROGRAM_DESC" headerAlign="center" align="left" allowSort="true" width="50" >程序描述
                <input property="editor" class="mini-textbox" style="width:100%;" minWidth="30" />
            </div>
