...
<script type="text/javascript" src="${ctx}/js/configuremanager/addRocketmqForStop.js"></script>
</head>
<body>
			...
			<tr>
				...
				<td>
					<input id="DEPLOY_FILE_TYPE" name="DEPLOY_FILE_TYPE" class="mini-combobox" style="width: 90%;" onvaluechanged="search()"
						textField="text" valueField="code" data="getSysDictData('rocketmq_deploy_type')" showNullItem="true" allowInput="false"/>
				</td>
