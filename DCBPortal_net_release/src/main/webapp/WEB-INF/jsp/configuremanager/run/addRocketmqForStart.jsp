...
<script type="text/javascript" src="${ctx}/js/configuremanager/addRocketmqForStart.js"></script>
</head>
<body>
<div id="mainDiv" class="mini-fit p5" style="overflow: auto;">
	<div style="border: 1px solid #b1c3e0">
        <div style="border-bottom: 1px dashed #b1c3e0;">
			...
			默认启动模式：<input id="defaultDeployType" name="defaultDeployType" class="mini-combobox" 
				onvaluechanged="changeDefaultDeployType('rocketmq')"
				style="width: 160px;margin-top:2px;margin-bottom: 2px;" data="getSysDictData('rocketmq_deploy_type')" 
		...
		<!-- <div id="queryForm" class="search">
			<table class="formTable8" style="width:100%;height:30px;table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>
						<input id="DEPLOY_FILE_TYPE" name="DEPLOY_FILE_TYPE" 
					...
					<td>
						<input id="QUERY_STATUS" name="QUERY_STATUS" 
							showNullItem="true" allowInput="false" data="getSysDictData('PROGRAM_STATE_LIST')"
							valueField="code" textField="text" class="mini-combobox" style="width:98%;"/>
					</td>
					<th>
	            		<span>版本:</span>
	            	</th>
					<td>
						<input id="QUERY_VERSION" name="QUERY_VERSION" 
							showNullItem="true" allowInput="false"
							valueField="VERSION" textField="VERSION"
							class="mini-combobox" style="width:98%;"/>
					</td>
