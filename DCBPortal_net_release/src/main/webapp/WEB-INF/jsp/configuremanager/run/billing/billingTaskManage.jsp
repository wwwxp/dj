...
<script language="javascript" type="text/javascript"
	src="${ctx}/js/configuremanager/run/billing/billingTaskManage.js"></script>
</head>
<body>
			...
			<table id="updateForm" class="formTable9"
				...
				<tr>
					...
					<td style="text-align: right;">
						<!-- <a class="mini-button mini-button-green" onclick="javascript:history.back();" plain="false">返回</a> -->
