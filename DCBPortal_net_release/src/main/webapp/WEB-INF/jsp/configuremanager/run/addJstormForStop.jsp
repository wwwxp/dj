...
<script type="text/javascript" src="${ctx}/js/configuremanager/addJstormForStop.js"></script>
</head>
<body>
			...
			<tr>
				...
				<td>
					<input id="DEPLOY_FILE_TYPE" name="DEPLOY_FILE_TYPE" class="mini-combobox" style="width: 90%;" onvaluechanged="search()"
						textField="text" valueField="code" data="getSysDictData('jstorm_deploy_type')" showNullItem="true" allowInput="false"/>
				</td>
		...
		<div id="inputForm">
			<div id="deploy_datagrid" class="mini-datagrid" allowCellEdit="true" 
				...
				<div property="columns">
					...
					<div field="DEPLOY_FILE_TYPE" headerAlign="center" align="center" width="80" allowSort="true">部署类型</div>
