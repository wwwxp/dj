...
<title>路由管理</title>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/configuremanager/run/route/routeTaskManage.js"></script>
</head>
<body>
	<div class="mini-fit p5" >
		...
		<div id="hostGrid" class="mini-datagrid"
			...
			<div property="columns">
				...
				<div field="HOST_IP" headerAlign="center" align="center">运行主机IP</div>
				<div field="HOST_NAME" headerAlign="center" align="center">主机名</div>
