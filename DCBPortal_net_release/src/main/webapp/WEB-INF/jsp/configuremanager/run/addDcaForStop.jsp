...
<script type="text/javascript" src="${ctx}/js/configuremanager/addDcaForStop.js"></script>
</head>
<body>
			...
			<tr>
				...
				<td>
					<input id="DEPLOY_FILE_TYPE" name="DEPLOY_FILE_TYPE" class="mini-combobox" style="width: 90%;" onvaluechanged="search()"
						textField="text" valueField="code" data="getSysDictData('dca_deploy_type')" showNullItem="true" allowInput="false"/>
				</td>
	...
	<div style="padding:5px 0px;overflow-y:auto;overflow-x:hidden;height: auto;">
		<div id="inputForm" >
			<div id="deploy_datagrid" class="mini-datagrid" allowCellEdit="true" 
				...
				idField="INST_ID" showFooter="false"  allowtResize="true">
				<div property="columns">
					<div type="checkcolumn" width="20"></div>
					<div field="HOST_IP" headerAlign="center" align="center" width="100">主机</div>
					<div field="DEPLOY_FILE_TYPE" headerAlign="center" align="center" width="60">部署类型</div>
					<div field="INST_NAME" headerAlign="center" align="center" width="100">实例名称</div>
					<div field="INST_PATH" headerAlign="center" align="center" width="160">实例路径</div>
					<div field="VERSION" headerAlign="center" align="center" width="40">版本</div>
					<div field="STATUS" headerAlign="center" align="center" width="60" renderer="onStatusRender">状态</div>
