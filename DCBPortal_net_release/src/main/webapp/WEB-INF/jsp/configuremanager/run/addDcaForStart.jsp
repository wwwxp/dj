...
<script type="text/javascript" src="${ctx}/js/configuremanager/addDcaForStart.js"></script>
</head>
<body>
<div id="mainDiv" class="mini-fit p5" style="overflow: auto;">
	<div style="border: 1px solid #b1c3e0">
        <div style="border-bottom: 1px dashed #b1c3e0;">
			...
			默认启动模式：<input id="defaultDeployType" name="defaultDeployType" CLUSTER_TYPE='dca' class="mini-combobox"
						  onvaluechanged="changeDefaultDeployType('dca')"
				style="width: 160px;margin-top:2px;margin-bottom: 2px;" data="getSysDictData('dca_deploy_type')" 
				...
				<tr>
					...
					<td>
						<input id="DEPLOY_FILE_TYPE" name="DEPLOY_FILE_TYPE" class="mini-combobox" style="width: 100%;"
							   data="getSysDictData('dca_deploy_type')"
							   textField="text" valueField="code" showNullItem="true" allowInput="false"/>
					</td>
					<th>
						<span>主机IP：</span>
					...
					<td>
						<input id="HOST_ID" name="HOST_ID" class="mini-combobox" style="width: 100%;"
							   textField="HOST_IP" valueField="HOST_ID" showNullItem="true" allowInput="false"/>
					</td>
					<th>
						<span>版本：</span>
					</th>
					<td>
						<input id="QR_VERSION" name="QR_VERSION" class="mini-combobox" textField="VERSION" valueField="VERSION"
							   showNullItem="true" allowInput="false" style="width: 100%;"/>
					</td>
					<th>
						<span>状态：</span>
					</th>
