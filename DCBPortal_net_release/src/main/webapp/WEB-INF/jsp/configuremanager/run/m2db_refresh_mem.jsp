...
<script type="text/javascript" src="${ctx}/js/configuremanager/m2db_refresh_mem.js"></script>
</head>
<body>
<div id="mainDiv" class="mini-fit p5" style="overflow: auto;">
	...
	<div style="padding:5px 0px;overflow-y:auto;overflow-x:hidden;height: auto;">
		<div id="inputForm">
			<table id="paramsTable" class="formTable6" style="table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
				<colgroup>
					<col width="80px"/>
					<col/>
					<col width="80px"/>
				...
				<tbody id="paramsInfo">
					<tr>
					    ...
					    <td><input  type="text" id="instanceName" name="instanceName" popupWidth="100%" popupHeight="260px"
					    	class="mini-combobox" textField="INSTANCE_NAME" valueField="INSTANCE_NAME" required="true" style="width:100%"/></td>
					    
					    <th><span style="color: red">*</span>Bolt：</th>
					    <td><input  type="text" id="bolt" name="bolt" class="mini-textbox"  required="true" style="width:100%"/></td>
					    <td><span style="color: red">请填写需要刷新的bolt名称</span></td>
					 </tr>
				</tbody>
			</table>
		</div>
