...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/configuremanager/addDmdbNewForStart.js"></script>
</head>
<body>
	...
	<div style="border: 1px solid #b1c3e0">
		<div style="border-bottom: 1px dashed #b1c3e0;">
			...
			默认启动模式：<input id="defaultDeployType" name="defaultDeployType" class="mini-combobox"
						  onvaluechanged="changeDefaultDeployType('dmdb')"
						  style="width: 160px;margin-top:2px;margin-bottom: 2px;" data="getSysDictData('dmdb_deploy_type')"
