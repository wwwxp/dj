...
<script language="javascript" type="text/javascript" src="${ctx}/js/configuremanager/editconfig/platformconfigure.js"></script>
     <!--   主题样式 start -->
     <!--默认  codemirror.css-->
	...
	<div class="mini-splitter"  style="width: 100%; height: 100%;" borderStyle="border:0px;">
	    <div size="300" showCollapseButton="true" style="border:#b1c3e0 1px solid;border-top: none;" minSize="300">
	        ...
	        <div class="mini-fit">
	            <ul id="fileTree" class="mini-tree" ondrawnode="distinIsUsed" showCheckBox="true"
	                ...
	                expandOnLoad="0" onNodeclick="onClickTreeNode" contextMenu="#tree_left_menu">
	            </ul>
	           	<ul id="tree_left_menu" class="mini-contextmenu" onbeforeopen="onBeforeOpen">
	                ...
	                <li id="newFolder" iconCls="icon-node" onclick="newFile('folder')">新建实例</li>
	               	<li id="renameFile" iconCls="icon-reload" onclick="renameFile">重命名</li>
	                <li id="deleteFile" iconCls="icon-remove" onclick="deleteFile('file')">删除</li> 
	                <li id="deleteFolder" iconCls="icon-remove" onclick="deleteFile('folder')">删除</li>
					<li id="deleteFolderExDefault" iconCls="icon-remove" onclick="deleteFileExDefault('folder')">清空实例</li>
					<li id="deleteBatch" iconCls="icon-remove" onclick="deleteBatchNode('folder')">批量删除</li>
	            </ul>
	        </div>
	    </div>
	    <div style="border:#b1c3e0 1px solid;">
		    ...
		    <div class="mini-fit">
		        ...
		        <div id="saveFile" style="text-align: center;margin-top:0px;display:none;border-top:#b1c3e0 1px solid;">
			      	<a class="mini-button mini-button-green" id="saveFileButton" onclick="saveAndDisFile" style="width:150px;text-algin:center;margin-top: 5px;">保存</a>
			    </div>
		   </div>
		</div>
	</div>
