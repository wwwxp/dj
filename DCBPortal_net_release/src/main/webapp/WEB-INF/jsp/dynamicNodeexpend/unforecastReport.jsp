...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="${ctx}/js/dynamicNodeexpend/unforecastReport.js"
...
<body>
	<div class="mini-fit p5">
		 <p id="k1" style="display: none;">&nbsp;&nbsp;&nbsp;&nbsp;根据集群中的主机资源监控近一个月的历史数据分析出，将在未来时间：<span style="white-space: pre;margin: 0px;padding: 0px;">【<label id="PREDICTION_TIME"></label>】</span>触发预测阀值并超过警戒线,实行收缩。</p>
		 <p id="k2" style="display: none;">&nbsp;&nbsp;&nbsp;&nbsp;根据集群中的主机资源监控近一个月的历史数据分析出，将在未来时间30天不会触发预测阀值，不用实行收缩。</p>
		 ...
		 <p align="right" style="height: 30px;color: #CFCFCF"> 报告生成时间：<label id="CRT_DATE"></label></p>
		 </div>
