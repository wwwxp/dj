...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="${ctx}/js/dynamicNodeexpend/expansionReport.js"
...
<div class="mini-fit p5">
		 <p>&nbsp;&nbsp;&nbsp;&nbsp;根据集群中的主机资源监控近一个月的历史数据分析出，已触发预测扩容阀值并超过警戒线，实行扩容。</p>
		 ...
		 <table class="formTable6" style="table-layout: fixed;">
		  <colgroup>
		 	...
		 	<tr>
		 	 	<td colspan="5">
		 	 	根据以上指标统计建议扩容【
		 	 	<label style="color:red" id="ADVISE_NODE_COUNT"></label>&nbsp;】台
		 	 	</td> 
		 	</tr>
		 </table> 
