...
<head>
	...
	<script src="${ctx}/js/dynamicNodeexpend/manualConfig.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="mini-toolbar" style="height:28px;text-align: center; padding-top: 8px; padding-bottom: 8px;"
        ...
        <a class="mini-button" onclick="onSubmit" style="width:60px;margin-right:20px;">执行</a> 
