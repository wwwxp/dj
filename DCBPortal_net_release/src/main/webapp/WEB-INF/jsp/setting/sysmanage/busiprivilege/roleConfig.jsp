...
<head>
    ...
    <script src="${ctx}/js/setting/sysmanage/busiprivilege/roleConfig.js" type="text/javascript"></script>
    <title>角色管理</title>
</head>
<body>
    ...
    <div class="mini-fit" style="margin-top: 5px;">
        <div id="role_datagrid" class="mini-datagrid" style="width: 100%; height: 100%"
            ...
            <div property="columns"> 
                ...
                <div field="ROLE_STATE_NAME" width="150" headerAlign="center" align="center">状态</div>
                <div field="CRT_DATE" dateFormat="yyyy-MM-dd HH:mm:ss" width="150" headerAlign="center" align="center">创建时间</div>
                <div field="REMARK" width="200" headerAlign="center">角色描述</div>
