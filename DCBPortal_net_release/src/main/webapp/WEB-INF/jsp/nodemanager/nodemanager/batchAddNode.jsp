...
<div class="mini-fit p5">
    <table id="nodeForm" class="formTable6"
        ...
        <tr>
            ...
            <td><input width="100%" id="HOST_IP" name="HOST_IP_USER" class="mini-combobox"
                       required="true" textField="HOST_IP_USER" valueField="NODE_HOST_ID"
                       multiSelect="true"/></td>
        </tr>
        <tr>
            ...
            <td><input width="100%" id="NODE_TYPE" name="NODE_TYPE" class="mini-combobox"
                       ...
                       popupMaxHeight="150" allowInput="true"
                       <%--multiSelect="true"--%>/></td>
            <th>业务组：</th>
        ...
        <tr>
            ...
            <td colspan="3"><input width="100%" id="NODE_PATH" name="NODE_PATH"
                       textField="NODE_PATH" valueField="NODE_PATH"
                       class="mini-textbox" required="true" allowInput="true" /></td>

            <%--<th>节点状态：</th>--%>
            <%--<td>--%>
                <%--<input width="100%" popupHeight="60px"  name="NODE_STATE" id="NODE_STATE"--%>
