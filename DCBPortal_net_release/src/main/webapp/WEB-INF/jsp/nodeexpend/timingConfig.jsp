...
<head>
	...
	<script src="${ctx}/js/nodeexpend/timingConfig.js" type="text/javascript"></script>
    ...
    >
        ...
        >
            ...
            <tr>
             ...
             <tr>
                <th><span class="fred">*</span>是否关联规则：</th>
                <td>
                	<input width="100%" id="IS_RULE" name="IS_RULE" class="mini-combobox" textField="text" valueFiled="code"
                    	data="getSysDictData('is_param_list')" value="0" required="true"/>
                </td>
                 <th><span class="fred">*</span>状态：</th>
                <td>
                	<input width="100%" id="STATE" name="STATE" class="mini-combobox" textField="text" valueFiled="code"
                    	data="getSysDictData('job_task_cron_status')" value="1" required="true"/>
                </td>
            </tr>
