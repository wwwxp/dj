...
<head>
	...
	<script src="${ctx}/js/nodeexpend/thresholdConfig.js" type="text/javascript"></script>
            ...
            <tr>
                ...
                <td>
                	<input width="100%" id="QUOTA_TYPE" name="QUOTA_TYPE" class="mini-combobox" textField="text" valueFiled="code"
                    	data="getSysDictData('quota_type')" value="1" required="true" onvaluechanged="onqtaTypeChange"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                	<input id="CONDITION_COUNT" name="CONDITION_COUNT" class="mini-spinner"  
                		minValue="1" maxValue="100" value="2" style="width:100%;"/>
                </td>
            </tr>
           <!--  <tr>
