...
<head>
  ...
  <!--     文件内容搜索 -->
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/topconfig/topconfigManage.js"></script>
	<script type="text/javascript">
	 var templatePath='<%=java.net.URLEncoder.encode(SessionUtil.getConfigValue("WEB_HOST_ROOT_DIR")+"conf/config/")%>';
	</script>
</head>
<body>
    ...
    <div size="300" showCollapseButton="true" style="border: 1;" minSize="300">
        ...
        <div class="mini-fit">
            <ul id="fileTree" class="mini-tree"
                ...
                expandOnLoad="0"  ondrawnode="onDrawNode" onload="treeLoadEvent" 
