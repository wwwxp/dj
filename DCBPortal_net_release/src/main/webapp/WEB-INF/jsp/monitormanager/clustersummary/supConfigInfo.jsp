...
<head>
    ...
    <script language="javascript" type="text/javascript" src="${ctx}/js/monitormanager/clustersummary/supConfigInfo.js"></script>
</head>
<body>
	<div style="padding:5px;height:28px;">
		<span style="float:left;font-size:14px;line-height:28px;font-weight:bold;">Supervisor配置 </span>
