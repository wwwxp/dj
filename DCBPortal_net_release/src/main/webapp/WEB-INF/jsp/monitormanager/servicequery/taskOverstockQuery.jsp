...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/monitormanager/servicequery/taskOverstockQuery.js"></script>
	
</head>
<body>
	<div class="mini-fit" style="padding: 5px;overflow-y: auto;overflow-x:hidden; ">
		...
		<div style="height: 100%;">
			<div id="queryFrom" class="search" style="margin-top: 5px;">
				<table class="formTable8" style="width:80%;height:50px;table-layout: fixed; padding: 0" cellpadding="0" cellspacing="0">
					...
					<tr>
		            	...
		            	<th>
		            		<span><span class="fred">*</span>服务名称：</span>
		            	</th>
						<td>
						...
						<tr>
				        	...
				        	<td style="text-align: right;">
				               	<input id="SORT_RULE" name="SORT_RULE" class="mini-combobox" style="width: 100%;" required="true"
									...
									allowInput="false" onvaluechanged="changeSortRule()"/>
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="mini-fit" style="margin-top: 5px;">
				<div id="overstockGrid" class="mini-datagrid" style="width: 100%; height: 100%;" pageSize="10000"
		             idField="TASK_ID" allowResize="false" allowCellselect="false" multiSelect="true" showFooter="true" >
					<div property="columns">
						<div field="HOST_IP" width="100" headerAlign="center" align="center" renderer="onRenderHostTermial">主机</div>
						...
						<div field="MSG_COUNT" width="100" headerAlign="center" align="center">发送消息总量(向c进程)</div>
					</div>
				</div>
			</div>
		</div>
