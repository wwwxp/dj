...
<head>
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/monitormanager/servicequery/taskOverstockQueryWithGroup.js"></script>
	...
	<div class="mini-fit" style="padding: 5px;overflow-y: auto;overflow-x:hidden; ">
		...
		<div style="height: 100%;">
			...
			<div class="mini-fit" style="margin-top: 5px;">
				<div id="overstockGrid" class="mini-datagrid" style="width: 100%; height: 100%;" pageSize="100000"
