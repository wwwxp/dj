...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script language="javascript" type="text/javascript" src="${ctx}/js/develop/fileUpload.js"></script>
	<title> </title>
</head>
...
<body>
    <div class="mini-fit p5">
        <table id="fileForm" class="formTable6" style="table-layout: fixed;">
             ...
             <tr>
                <th  width="120"><span class="fred">*</span>文件名：</th>
               
                
                <td>
                <input width="100%" id="fileName" name="fileName" type="file" required="true"/>
                </td>
                </tr>
