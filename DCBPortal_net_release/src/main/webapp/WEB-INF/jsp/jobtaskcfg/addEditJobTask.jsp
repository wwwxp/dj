...
<script language="javascript" type="text/javascript" src="${ctx}/js/jobtaskcfg/addEditJobTask.js"></script>
</head>
<body>
	<div class="mini-fit p5">
        <table id="addEditForm" class="formTable6" style="table-layout: fixed;">
			...
			<tr>
				<th><span class="fred">*</span>任务执行类：</th>
				<td colspan="3">
					<input id="TASK_JOB_CLASS" name="TASK_JOB_CLASS" required="true"
						   class="mini-textbox" style="width: 100%;" />
				</td>
			</tr>
			<tr>
				<th><span class="fred">*</span>任务参数：</th>
				<td colspan="3">
					<input id="TASK_JOB_PARAMS" name="TASK_JOB_PARAMS" required="true"
						   class="mini-textarea" style="height: 100px;width: 100%;" />
				</td>

			</tr>
			<tr>
				<th><span class="fred"></span>任务描述：</th>
				<td colspan="3">
					<input id="TASK_DESC" name="TASK_DESC" required="true"
						   class="mini-textarea"  style="height: 100px;width: 100%;" />
				</td>
		            ...
		            <tr>
						...
						<td>
							<input width="100%" name="TRIGGER_TYPE" id="TRIGGER_TYPE" class="mini-combobox"
									...
									required="true" data="getSysDictData('job_type')"/>
						</td>
						
						<th><span class="fred">*</span>任务状态：</th>
						<td>
							<input width="100%" name="TASK_STATUS" id="TASK_STATUS" class="mini-combobox"
									textField="text" valueField="code"  
