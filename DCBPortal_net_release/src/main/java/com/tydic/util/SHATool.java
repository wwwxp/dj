...
public class SHATool {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SHATool.getSHA1StrJava("中国的但是多所 #$@*@*^*)(@^#*)(@#GLJGLJLKJDSHSHISYHASJDvvvvvvvvvvvvvvvvvv433333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333"));
