...
//	    entry = "-rwxrwxrwx   1 smpsys     tellin         524 8月 29日 16:40 tt.txt\n";
//        entry = "-rw-r--r--   1 iba3       iba             22 Sep  4 16:40 tt.txt";
        System.out.println("ftp file : " + entry);
        ...
        if (matches(entry))
        {
            ...
            try {
                ...
                try
                {
                    //对小机时间进行中文处理,无法获取年份，默认当前年份
                    System.out.println("ftp file datastr ---> " + datestr);
